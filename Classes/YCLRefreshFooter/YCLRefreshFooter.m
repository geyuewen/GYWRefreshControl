...
- (void)placeSubviews{
    ...
    self.line0.frame = CGRectMake(15, self.bounds.size.height/2.0, (self.bounds.size.width - width)/2.0 - (15), 0.5);
    
    self.line1.frame = CGRectMake((self.bounds.size.width + width)/2.0, self.bounds.size.height/2.0, (self.bounds.size.width - width)/2.0 - (15), 0.5);
}
